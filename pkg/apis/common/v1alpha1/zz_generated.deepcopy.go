...
func (in *ParameterConfiguration) DeepCopyInto(out *ParameterConfiguration) {
	*out = *in
	...
	if in.SpecToEnvs != nil {
		in, out := &in.SpecToEnvs, &out.SpecToEnvs
		*out = make([]SpecToEnvParameterConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SpecToVolumes != nil {
		in, out := &in.SpecToVolumes, &out.SpecToVolumes
		*out = make([]SpecToVolumeParameterConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpecToEnvParameterConfiguration) DeepCopyInto(out *SpecToEnvParameterConfiguration) {
	*out = *in
	if in.Render != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpecToEnvParameterConfiguration.
func (in *SpecToEnvParameterConfiguration) DeepCopy() *SpecToEnvParameterConfiguration {
	if in == nil {
		return nil
	}
	out := new(SpecToEnvParameterConfiguration)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpecToVolumeParameterConfiguration) DeepCopyInto(out *SpecToVolumeParameterConfiguration) {
	*out = *in
	if in.ValueFromConfigMap != nil {
		in, out := &in.ValueFromConfigMap, &out.ValueFromConfigMap
		*out = new(ObjectReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpecToVolumeParameterConfiguration.
func (in *SpecToVolumeParameterConfiguration) DeepCopy() *SpecToVolumeParameterConfiguration {
	if in == nil {
		return nil
	}
	out := new(SpecToVolumeParameterConfiguration)
	in.DeepCopyInto(out)
	return out
}

...
func (in *AddParameterConfiguration) DeepCopyInto(out *AddParameterConfiguration) {
	*out = *in
	if in.Key != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AddParameterConfiguration.
func (in *AddParameterConfiguration) DeepCopy() *AddParameterConfiguration {
	if in == nil {
		return nil
	}
	out := new(AddParameterConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ParameterConfiguration) DeepCopyInto(out *ParameterConfiguration) {
	*out = *in
	...
	if in.Add != nil {
		...
		*out = make([]AddParameterConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
